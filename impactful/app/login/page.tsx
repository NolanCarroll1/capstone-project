					...
					<p className="mt-8 text-center font-sans text-[14px] text-[#9aa3b2]">
						{mode === "sign-in" ? (
							<>
								...
								<button type="button" onClick={() => setMode("sign-up")} className="font-semibold text-black underline underline-offset-2">
									Sign up
								</button>
							</>
						) : (
							<>
								...
								<button type="button" onClick={() => setMode("sign-in")} className="font-semibold text-black underline underline-offset-2">
									Sign in
								</button>
							</>
						)}
