const stats = [
	{
		...
		change: "-12",
		barWidth: "70%",
		description: "Citizens noticed the imbalance in your consent design.",
	},
	{
		label: "REVENUE",
		value: 1420,
		...
		change: "+420",
		barWidth: "92%",
		description: "Advertiser data collection drove strong ad revenue.",
	},
	{
		label: "POPULATION",
		value: 515,
		...
		change: "+15",
		barWidth: "96%",
		description: "A few new residents moved in, drawn by business activity.",
	},
] as const;
	...
	return (
		<div className="rounded-[16px] border border-[#eceff3] bg-white px-4 py-4 shadow-[0_1px_0_rgba(0,0,0,0.02)]">
			...
			<div className="mt-4 h-2 rounded-full bg-[#eef1f5]">
				<div
					className={`h-full rounded-full ${isNegative ? "bg-[#aeb7c4]" : "bg-[#4b5563]"}`}
	...
	return (
		<main className="min-h-screen bg-[#f5f6f8] px-4 py-8 text-black sm:flex sm:items-center sm:justify-center sm:px-6 sm:py-6">
			<section className="w-full max-w-[393px]">
				...
				<div className="mt-8 rounded-[16px] bg-black px-4 py-5 text-white shadow-[0_16px_40px_rgba(0,0,0,0.12)]">
